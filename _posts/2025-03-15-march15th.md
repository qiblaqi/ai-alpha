...
- **ComfyUI Setup and FLUX.1 Dev Model Download**  
  ...
  ![ComfyUI Interface](https://raw.githubusercontent.com/qiblaqi/ai-alpha/main/images/2025-03-15/gpu.jpg "My former GPU setup")
...
- **Errors Fixed**
  It turns out that MPS does not support the bfloat16 version of the data type. So I changed it to an fp8 model.
...
- **Errors Remain and Other Solutions**
  LOL, it turns out that my previous solution did not solve the errors in the end! The final solution is to use DiffusionBee. :D gg noob.
